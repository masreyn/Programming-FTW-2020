...
function preload () {
  ...
  cardfaceArray = [
    loadImage('images/penguinc.png'),
    loadImage('images/owlc.png'),
    loadImage('images/pigc.png'),
    loadImage('images/bearc.png'),
    loadImage('images/foxc.png'),
    loadImage('images/catc.png')
  ]
}
function setup () {
...
function draw () {
  ...
  textSize(30);
  textStyle(NORMAL);
  text('Attempts:  ' + gameState.attempts, 120, 760);
  text('Matches:  ' + gameState.numMatched, 310, 760);
}
