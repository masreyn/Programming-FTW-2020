/* Assign 7A create collection object that has 3 to 5 properties.
Create an array of exactly 5 of these objects and include this array as one of the properties in your Vue data object. */
...
const guitarArry = [
  ...
  // Guitar 4 = Object 4 Teardrop Vox Mark III
  {
    ...
    players: 'The Mark III was made for Brian Jones of The Rolling Stones'
  },
  ...
  // Guitar 5 = Object 5. Mosrite Mark V Mosrite Mark V Ventures
  {
    ...
    period: '1956-94',
    pickups: '2 Single-coil',
    players: 'Ventures, Johnny Ramone, Ricky Wilson B-52s, Dave Alexander-Stooges, Robert Smith-Cure'
  }
];
