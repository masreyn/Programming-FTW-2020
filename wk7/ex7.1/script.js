...
var vm = new Vue ({
  ...
  data: {
    ...
    llamaFacts: [
      ...
      { text: 'Llamas are can weigh to 400 pounds.' },
      { text: 'Llamas have long banana-shaped ears.' },
    ...
    alpacaFacts: [
      ...
      { text: 'Alpacas only get to about 175 pounds.' },
      { text: 'Alpacas have short straight ears.' },
